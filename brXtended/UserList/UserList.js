define([
  ...
  "widgets/brXtended/UserList/libs/Model",
  "widgets/brXtended/UserList/libs/Controller",
  "widgets/brXtended/UserList/libs/Config",
  "widgets/brXtended/UserList/libs/Renderer",
  ...
  /**
   * @class widgets.brXtended.UserList
   *
  ...
  p._resolveEditUserSameLevel = function (def, rowUserData) {
    ...
    this.model
      ...
      .then(function () {
        ...
        widget._retrieveEditUserSameLevel(def).then(
          function () {
